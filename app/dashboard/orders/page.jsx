      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg border p-4">
          ...
          <nav className="space-y-2">
            ...
            <Link href="/dashboard/orders" className="block py-2 px-3 bg-blue-50 text-blue-700 rounded font-medium">
              My Orders
            </Link>
            ...
            <Tabs defaultValue="all">
                    ...
                    <div key={order.orderId} className="border rounded-lg p-4">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-700">{order.productTitle || "Product"}</p>
              ...
              <TabsContent value="cancelled" className="space-y-4">
                {orders.filter((o) => o.status === "cancelled").length === 0 ? (
                  <p className="text-center py-4 text-gray-500">No cancelled orders</p>
                ) : (
                  orders
